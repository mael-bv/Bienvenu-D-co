...
$message = new Message();
 ...
 if(!empty($_POST)){
   // $messagerie = $message->message($_POST['submit'],$_POST['check'],$_POST['name'],$_POST['mail'],$_POST['num'],$_POST['mess']);
    $erreur = $message->message($_POST['submit'],@$_POST['check'],$_POST['name'],$_POST['mail'],$_POST['num'],$_POST['mess']);
...
<style>
    ...
    <form method="post">      
            ...
            <div class="condition">  
                ...
                <label class="checkLabel" for="checkbox"><a href="mention.php"> Accepter les conditons de généralité </a></label>
            </div><br>
